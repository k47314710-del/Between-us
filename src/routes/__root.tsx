...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Two phones connected by love. Step into each other's day, always connected.",
      },
      { name: "author", content: "Krishna & Varshini" },
      { property: "og:title", content: "Between Us — Our Little World" },
      {
        property: "og:description",
        content: "Two phones connected by love. Krishna and Varshini.",
      },
